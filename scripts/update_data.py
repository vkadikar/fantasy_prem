...
def get_team_details(api):
    ...
    try:
        ...
        data = request(api, Method("getStandings", view="Classic"))
        details = {}
...
def get_matchups(api):
    ...
    try:
        ...
        standings_data = request(api, Method("getStandings", view="SCHEDULE"))
        ...
        for tid in team_ids:
            ...
            if tid_str in roster_cache[week_str]:
                ...
                try:
                    ...
                    roster_data = request(api, Method("getTeamRosterInfo", teamId=tid, period=week))
    ...
    try:
        ...
        for i, tid in enumerate(team_ids):
            try:
                ...
                roster_data = request(api, Method("getTeamRosterInfo", teamId=tid, period=CURRENT_WEEK))
...
def load_aggregated_stats(base_dir):
    """
    Loads all weekly player stat files from the player_data directory 
